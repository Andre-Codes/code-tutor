...
def main():
    ...
    image_file = st.file_uploader("Upload a visualization image file", key='image_file')
    ...
    system_role = """
       ...
       debug, and write efficient code for generating visualizations. Always
       include a code snippet of the complete code in your responses. You only
       respond to coding and visualization questions.
       """
